...
export const data: TermsData[] = [
    ...
    },
    {
        ...
        articleContents: [
            ...
            },
            {
                type: 'contents',
                contents:
                    "크롤(이하 ‘회사'라고 함)는 회사가 제공하고자 하는 서비스(이하 ‘회사 서비스’)를 이용하는 개인(이하 ‘이용자’ 또는 ‘개인’)의 정보(이하 ‘개인정보’)를 보호하기 위해, 개인정보보호법, 정보통신망 이용촉진 및 정보보호 등에 관한 법률(이하 '정보통신망법') 등 관련 법령을 준수하고, 서비스 이용자의 개인정보 보호 관련한 고충을 신속하고 원활하게 처리할 수 있도록 하기 위하여 다음과 같이 개인정보처리방침(이하 ‘본 방침’)을 수립합니다.",
            },
        ],
    },
    {
        ...
        articleContents: [
            ...
            },
            {
                ...
                list: [
                    ...
                    {
                        contents: '회사는 제1항에 따라 본 방침을 개정하는 경우 다음 각 호 하나 이상의 방법으로 공지합니다.',
                        children: {
                            contents: [
    ...
    },
    {
        ...
        articleContents: [
            ...
            {
                type: 'contents',
                contents: '회사는 이용자의 회사 서비스에 대한 회원가입을 위하여 다음과 같은 정보를 수집합니다.',
            },
            {
                type: 'list',
    ...
    },
    {
        ...
        articleContents: [
            ...
            {
                type: 'contents',
                contents: '회사는 다음과 같은 방법으로 이용자의 개인정보를 수집합니다.',
            },
            {
                type: 'list',
                list: [
                    { contents: '이용자가 회사의 홈페이지에 자신의 개인정보를 입력하는 방식' },
                    {
                        contents:
    ...
    },
    {
        ...
        articleContents: [
            ...
            {
                type: 'contents',
                contents: '회사는 관계법령에 따라 다음과 같이 개인정보를 보유 및 이용합니다.',
            },
            {
                type: 'list',
                list: [
                    {
                        contents: '전자상거래 등에서의 소비자보호에 관한 법률에 따른 보유정보 및 보유기간',
                        children: {
                            contents: [
                    ...
                    },
                    {
                        ...
                        children: {
                            contents: ['웹사이트 로그 기록 자료 : 3개월'],
                        },
                    },
                    {
                        contents: '전자금융거래법에 따른 보유정보 및 보유기간',
                        children: {
                            contents: ['전자금융거래에 관한 기록 : 5년'],
                        },
                    },
                    {
                        contents: '위치정보의 보호 및 이용 등에 관한 법률',
                        children: {
                            contents: ['개인위치정보에 관한 기록 : 6개월'],
                        },
                    },
                ],
            },
        ...
        articleContents: [
            ...
            },
            {
                ...
                list: [
                    ...
                    { contents: '회사는 파기 사유가 발생한 개인정보를 개인정보보호 책임자의 승인절차를 거쳐 파기합니다.' },
                ],
            },
        ],
    },
            ...
            },
            {
                ...
                list: [
                    ...
                    },
                    {
                        ...
                        children: {
                            contents: ['회사명 및 연락처', '수신 거부 또는 수신 동의의 철회 의사표시에 관한 사항의 표시'],
                        },
                    },
                    {
                        contents:
    ...
    },
    {
        ...
        articleContents: [
            {
                type: 'article-title',
                title: '제16조(개인정보 자동 수집 장치의 설치·운영 및 거부에 관한 사항)',
            },
            {
                type: 'list',
                list: [
    ...
    },
    {
        ...
        articleContents: [
            {
                type: 'article-title',
                title: '제17조(쿠키 설치 허용 지정 방법)',
            },
            {
                type: 'contents',
                contents: '웹브라우저 옵션 설정을 통해 쿠키 허용, 쿠키 차단 등의 설정을 할 수 있습니다.',
            },
            {
                type: 'list',
                list: [
                    ...
                    { contents: 'Chrome : 웹브라우저 우측 상단의 설정 메뉴 > 개인정보 및 보안 > 쿠키 및 기타 사이트 데이터' },
                    { contents: 'Whale : 웹브라우저 우측 상단의 설정 메뉴 > 개인정보 보호 > 쿠키 및 기타 사이트 데이터' },
                ],
            },
        ],
    },

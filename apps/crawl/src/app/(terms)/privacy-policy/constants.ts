    ...
    articleContents: [
      ...
      },
      {
        ...
        list: [
          ...
          {
            contents:
              "크롤은 제1항에 따라 본 방침을 개정하는 경우 다음 각 호 하나 이상의 방법으로 공지합니다.",
            children: {
              contents: [
  ...
  },
  {
    ...
    articleContents: [
      ...
      },
      {
        type: "contents",
        contents:
          "크롤은 이용자의 서비스에 대한 회원가입을 위하여 다음과 같은 정보를 수집합니다.",
      },
      {
        type: "list",
  ...
  },
  {
    ...
    articleContents: [
      ...
      },
      {
        type: "list",
        list: [
          { contents: "필수 수집 정보: 서비스 이용기록, 쿠키 및 기기정보" },
        ],
      },
    ],
  },
    ...
    articleContents: [
      ...
      },
      {
        ...
        list: [
          {
            contents:
              "이용자가 크롤의 홈페이지에 자신의 개인정보를 입력하는 방식",
          },
        ],
      },
    ],
  ...
  },
  {
    ...
    articleContents: [
      ...
      },
      {
        type: "contents",
        contents:
          "크롤은 관계법령에 따라 다음과 같이 개인정보를 보유 및 이용합니다.",
      },
      {
        type: "list",
        list: [
    ...
    articleContents: [
      ...
      },
      {
        ...
        list: [
          ...
          {
            contents:
              "크롤은 파기 사유가 발생한 개인정보를 개인정보보호 책임자의 승인절차를 거쳐 파기합니다.",
          },
        ],
      },
    ],

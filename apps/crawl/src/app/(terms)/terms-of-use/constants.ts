    ...
    },
    {
        ...
        articleContents: [
            ...
            },
            {
                type: 'contents',
                contents:
                    "본 약관은 크롤가 운영하는 온라인 쇼핑몰 'https://homepage.crawl-lab.shop/'에서 제공하는 서비스(이하 '서비스'라 합니다)를 이용함에 있어 당사자의 권리 의무 및 책임사항을 규정하는 것을 목적으로 합니다. PC통신, 무선 등을 이용하는 전자상거래에 대해서도 그 성질에 반하지 않는 한 본 약관을 준용합니다.",
            },
        ],
    },
    {
        ...
        articleContents: [
...

            {
                ...
                list: [
                    ...
                    { contents: "회원가입 시기는 '회사'의 가입승낙 안내가 '회원'에게 도달한 시점으로 합니다." },
                ],
            },
        ],
    },
        ...
        articleContents: [
            ...
            },
            {
                ...
                list: [
                    ...
                    {
                        contents: "'쇼핑몰'은 다음 각호의 사유가 발생한 경우 '회사'의 자격을 제한 또는 정지시킬 수 있습니다.",
                        children: {
                            contents: [
                                '회원가입 시 허위정보를 기재한 경우',
                    ...
                    {
                        contents:
                            "휴면계정 전환 시 계정 활성을 위해 필요한 아이디(ID), 비밀번호, 이름, 중복가입 방지를 위한 본인 인증값(DI), 휴대전화 번호를 제외한 나머지 정보는 별도로 저장 및 관리됩니다. 다만, 관계법령에 의해 보존할 필요가 있는 경우 '회사'는 정해진 기간 동안 회원정보를 보관합니다.",
                    },
                ],
            },
        ],
    ...
    },
    {
        ...
        articleContents: [
            ...
            },
            {
                ...
                list: [
                    {
                        contents: '재화 또는 용역의 검색 및 선택',
                    },
                    {
                        contents: '성명, 주소, 연락처, 전자우편주소 등 구매자 정보 입력',
                    },
                    {
                        contents:
                            '약관내용, 청약철회가 제한되는 서비스, 배송료 등 비용부담과 관련된 내용에 대한 확인 및 동의 표시',
                    },
                    { contents: '재화 또는 용역 등에 대한 구매신청 및 확인' },
                    { contents: '결제방법 선택 및 결제' },
                    { contents: "'회사'의 최종 확인" },
                ],
            },
        ],
        ...
        articleContents: [
            ...
            },
            {
                ...
                list: [
                    ...
                    { contents: "'회원'은 부여된 아이디(ID)와 비밀번호를 직접 관리해야 합니다." },
                    {
                        contents:
    ...
    },
    {
        ...
        articleContents: [
            ...
            },
            {
                ...
                list: [
                    {
                        contents: "'쇼핑몰'이 제공하는 서비스 및 이와 관련된 모든 지식재산권은 '회사'에 귀속됩니다",
                    },
                    {
                        contents:
